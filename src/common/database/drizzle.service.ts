...
export class DrizzleService implements OnModuleInit, OnModuleDestroy {
    ...
    constructor() {
        ...
        * */
        ...
        const idleTimeout = Math.floor(parseInt(process.env.DB_IDLE_TIMEOUT || '30000', 10) / 1000);
        /*
        ...
        * */
        const connectionTimeout = Math.floor(parseInt(process.env.DB_CONNECTION_TIMEOUT || '2000', 10) / 1000);
